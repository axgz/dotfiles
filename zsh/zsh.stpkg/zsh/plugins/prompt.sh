...
# Create prompt
export PS1='%F{$THEME_COLOURS_PS1_PWD}%~$(git_branch_name)$(git_commits_ahead)$(git_commits_behind)$(git_files_staged)$(git_files_modified)$(git_files_untracked) %F{$THEME_COLOURS_PS1_PROMPT}> %F{$THEME_COLOURS_PS1_TEXT}'
